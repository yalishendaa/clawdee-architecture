...
//
// Minimal version for ClawHub registry. Only writes to ~/.claude-lab/shared/secrets/transcript-api-key.
...
//   4. API key is saved to ~/.claude-lab/shared/secrets/transcript-api-key for agent runtime access.
//
...
// Save API key to ~/.claude-lab/shared/secrets/transcript-api-key only.
...
tapi-auth.js v${VERSION} - TranscriptAPI Account Setup (ClawHub Edition)
  ...
  (~/.claude-lab/shared/secrets/transcript-api-key) for agent runtime access.
